...
const currentImports = {};
      ...
      let moduleMap = {
"./SupplierComponent":()=>{
      dynamicLoadingCss(["style-7f7db56d.css"], false, './SupplierComponent');
      return __federation_import('./__federation_expose_SupplierComponent-0aa0d12f.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
        ...
        cssFilePaths.forEach(cssPath => {
         ...
         if (baseUrl) {
          ...
          if (dontAppendStylesToHead) {
            const key = 'css__supplierApp__' + exposeItemName;
