...
import { Button } from 'vite-ui-components';
...
function App() {
  ...
  const loadSupplierComponent = async () => {
    try {
      ...
      const remoteUrl = `${config.supplierHost}/assets/remoteEntry.js`;
      
      const module = await import(/* @vite-ignore */ remoteUrl);
      const Component = module.default || module.SupplierComponent;
    ...
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <div style={{ margin: '20px 0', padding: '15px', border: '1px solid #ccc', borderRadius: '5px', backgroundColor: '#f9f9f9' }}>
        ...
        <p style={{ fontSize: '12px', color: '#666', marginTop: '5px' }}>
          💡 You can also use URL parameter: <code>?supplierHost=http://example.com:4001</code>
        </p>
      </div>
